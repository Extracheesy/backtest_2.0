...
if __name__ == '__main__':
    ...
    try:
        ...
        pass
    try:
        df_results.to_csv("bigwill_final_results.csv")
    except:
        df_results.to_csv("bigwill_final_results_2.csv")
    ...
    lst_stochOverBought = [0.7, 0.8]
    lst_stochOverSold = [0.3, 0.4]
    lst_willOverSold = [-80, -85, -90, -95]
    lst_willOverBought = [-15, -10, -5]
    ...
    df_final_results.to_csv("bigwill_final_global_results.csv")

    lst_columns = ['stop_loss', "stochOverBought", "stochOverSold", "willOverSold", "willOverBought",
    ...
    df_store_final_resutls.to_csv("bigwill_final_global_results_filtered.csv")
    print('**************************')
